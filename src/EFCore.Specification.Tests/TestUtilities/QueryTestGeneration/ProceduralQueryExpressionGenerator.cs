...
namespace Microsoft.EntityFrameworkCore.TestUtilities.QueryTestGeneration
{
    public class ProceduralQueryExpressionGenerator
    {
        ...
        public ProceduralQueryExpressionGenerator(DbContext context)
        {
            ...
            {
                //new AppendSelectConstantExpressionMutator(),
                //new AppendSelectIdentityExpressionMutator(),
                //new AppendSelectPropertyExpressionMutator(),
                //new AppendOrderByIdentityExpressionMutator(),
